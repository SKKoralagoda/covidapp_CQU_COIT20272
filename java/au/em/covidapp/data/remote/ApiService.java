...
public interface ApiService {
  ...
  //Functions to generate related response and requests for app processes
  //For register
  ...
  //Class to support http libraries to integrate RestAPI
  class Creator {

...
public class PreferenceHelper {
  ...
  //variable to store preference values
  private static final String PREF_FILE_NAME = "beFit_file";

  //To declare SharedPreference class
  ...
  //To save all common preferences valuues
  ...
  //To take user values and save updated values
  ...
  //To remove preferences values of user
  ...
  //To get values related Object of User

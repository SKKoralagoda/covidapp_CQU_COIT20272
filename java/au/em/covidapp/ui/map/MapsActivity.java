...
public class MapsActivity extends BaseActivity implements OnMapReadyCallback,
  ...
  @OnClick({R.id.set_email, R.id.set_alert}) public void onViewClicked(View view) {
    switch (view.getId()) {
      case R.id.set_email:
        sendEmail();
      case R.id.set_alert:
  ...
  private void sendEmail() {
    ...
    it.putExtra(Intent.EXTRA_SUBJECT,"COVID_19 treatment");
    it.putExtra(Intent.EXTRA_TEXT,"You have seems to be affected by COVID-19 on high skill.Please contact near by consultant and start treatment.");
